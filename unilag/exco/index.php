...
if (isset($_REQUEST['login'])){
  ...
  //CHeck if the user is an exco and is from this school before continuing  
    ...
    if ($rslt['exco'] == "1" && $pwd == $rslt['password'] && $rslt['school'] == "unilag"){
       $_SESSION['unilag_exco'] = $user;//set specific session based on the school
       header('Location: http://nfcps.org.ng/unilag/exco/exco.php'); 
    } else {
...
<html>
    ...
    <body>
        ...
        <div id="header">
            <img alt="NFCPS UNILAG BLOG" width="100%" src="ui/b_img/header.png" />
        </div>
