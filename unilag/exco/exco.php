<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['unilag_exco']);//logout code
if(!isset($_SESSION['unilag_exco'])) header('location: http://nfcps.org.ng/unilag/exco/');
$user = $_SESSION['unilag_exco'];
require('/home/sites/nfcps.org.ng/public_html/unilag/functions.php');
...
<html>
    <head>
         <title>Administator - UNILAG BLOG</title>
...
<div class="well">
                    <h5><a href="http://nfcps.org.ng/unilag" target="_blank">Back to  blog</a></h5>
                </div>
            </div>
