<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['abu_exco']);//logout code
if(!isset($_SESSION['abu_exco'])) header('location: /abu/exco/');
$user = $_SESSION['abu_exco'];
...
<html>
    <head>
         <title>Administator - ABU BLOG</title>
    ...
    <body>
        ...
        <div id="body" class="row">
            <div class="col-sm-3">
                ...
                <div class="well">
                    <h5><a href="http://nfcps.org.ng/abu" target="_blank">Back to blog</a></h5>
                </div>
            </div>
