<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['ndu_exco']);//logout code
if(!isset($_SESSION['ndu_exco'])) header('location: /ndu/exco/');
$user = $_SESSION['ndu_exco'];
require('/home/sites/nfcps.org.ng/public_html/ndu/functions.php');
...
<html>
    <head>
         <title>Administator - NDU BLOG</title>
    ...
    <body>
        ...
        <div id="body" class="row">
            <div class="col-sm-3">
                ...
                <div class="well">
                    <h5><a href="http://nfcps.org.ng/ndu" target="_blank">Back to blog</a></h5>
                </div>
            </div>
