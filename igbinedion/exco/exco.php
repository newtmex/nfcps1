<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['igbinedion_exco']);//logout code
if(!isset($_SESSION['igbinedion_exco'])) header('location: /igbinedion/exco/');
$user = $_SESSION['igbinedion_exco'];
require('/home/sites/nfcps.org.ng/public_html/igbinedion/functions.php');
...
<html>
    <head>
         <title>Administator - IGBINEDION BLOG</title>
    ...
    <body>
        ...
        <div id="body" class="row">
            <div class="col-sm-3">
                ...
                <div class="well">
                    <h5><a href="http://nfcps.org.ng/igbinedion" target="_blank">Back to blog</a></h5>
                </div>
            </div>
