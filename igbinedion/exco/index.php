<?php
session_start();
require('/home/sites/nfcps.org.ng/public_html/delsu/functions.php');
if (isset($_REQUEST['login'])){
  ...
  //CHeck if the user is an exco and is from this school before continuing  
    ...
    if ($rslt['exco'] == "1" && $pwd == $rslt['password'] && $rslt['school'] == "delsu"){
       $_SESSION['delsu_exco'] = $user;//set specific session based on the school
...
<html>
    <head>
         <title>Administator - DELSU BLOG</title>
         <base href="http://www.nfcps.org.ng">
         <link rel="icon" href="/img/delsu.jpg">
        <link rel="stylesheet" href="css/bootstrap.min.css">
        <link rel="stylesheet" href="css/design.css">
        <link rel="stylesheet" href="delsu/blog_design.css">
    ...
    <body>
        ...
        <div id="header">
            <img alt="NFCPS delsu BLOG" width="100%" src="delsu/b_img/header.png" />
        </div>
