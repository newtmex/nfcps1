<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['uniuyo_exco']);//logout code
if(!isset($_SESSION['uniuyo_exco'])) header('location: http://nfcps.org.ng/uniuyo/exco/');
$user = $_SESSION['uniuyo_exco'];
require('/home/sites/nfcps.org.ng/public_html/uniuyo/functions.php');
...
<html>
    <head>
         <title>Administator - UNIUYO BLOG</title>
                    <base href="http://www.nfcps.org.ng">
         <link rel="icon" href="/img/uniuyo.jpg">
        <link rel="stylesheet" href="css/bootstrap.min.css">
        <link rel="stylesheet" href="css/design.css">
        <link rel="stylesheet" href="uniuyo/blog_design.css">
    ...
    <body>
        ...
        <div id="header">
            <img alt="NFCPS UNIUYO BLOG" width="100%" src="uniuyo/b_img/header.png" />
        </div>
...
<div class="well">
                    <h5><a href="http://nfcps.org.ng/uniuyo" target="_blank">Back to  blog</a></h5>
                </div>
            </div>
