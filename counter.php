...
imagecopymerge($im, $src1, 0, 0, 0, 0, 34, 46, 100);
imagecopymerge($im, $src2, 36, 0, 0, 0, 34, 46, 100);
imagecopymerge($im, $src3, 72, 0, 0, 0, 34, 46, 100);
imagecopymerge($im, $src4, 108, 0, 0, 0, 34, 46, 100);
imagecopymerge($im, $src5, 144, 0, 0, 0, 34, 46, 100);
