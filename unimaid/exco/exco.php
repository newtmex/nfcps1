<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['unimaid_exco']);//logout code
if(!isset($_SESSION['unimaid_exco'])) header('location: http://nfcps.org.ng/unimaid/exco/');
$user = $_SESSION['unimaid_exco'];
require('/home/sites/nfcps.org.ng/public_html/unimaid/functions.php');
...
<html>
    <head>
         <title>Administator - UNIMAID BLOG</title>
...
<div class="well">
                    <h5><a href="http://nfcps.org.ng/unimaid" target="_blank">Back to  blog</a></h5>
                </div>
            </div>
