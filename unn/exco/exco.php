<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['unn_exco']);//logout code
if(!isset($_SESSION['unn_exco'])) header('location: /exco/');
$user = $_SESSION['unn_exco'];
...
<html>
    <head>
         <title>Administator - UNN BLOG</title>
                    <base href="http://www.nfcps.org.ng">
         <link rel="icon" href="/img/unn.jpg">
        <link rel="stylesheet" href="css/bootstrap.min.css">
        <link rel="stylesheet" href="css/design.css">
        <link rel="stylesheet" href="unn/blog_design.css">
    ...
    <body>
        ...
        <div id="header">
            <img alt="NFCPS UNN BLOG" width="100%" src="unn/b_img/header.png" />
        </div>
        ...
        <div id="body" class="row">
            <div class="col-sm-3">
                ...
                <div class="well">
                    <h5><a href="http://unn.nfcps.org.ng" target="_blank">Back to  blog</a></h5>
                </div>
            </div>
