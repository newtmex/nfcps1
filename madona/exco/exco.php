<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['madona_exco']);//logout code
if(!isset($_SESSION['madona_exco'])) header('location: /madona/exco/');
$user = $_SESSION['madona_exco'];
require('/home/sites/nfcps.org.ng/public_html/madona/functions.php');
...
<html>
    <head>
         <title>Administator - MADONA BLOG</title>
    ...
    <body>
        ...
        <div id="body" class="row">
            <div class="col-sm-3">
                ...
                <div class="well">
                    <h5><a href="http://nfcps.org.ng/madona" target="_blank">Back to blog</a></h5>
                </div>
            </div>
