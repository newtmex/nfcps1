<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['oou_exco']);//logout code
if(!isset($_SESSION['oou_exco'])) header('location: /oou/exco/');
$user = $_SESSION['oou_exco'];
require('/home/sites/nfcps.org.ng/public_html/oou/functions.php');
...
<html>
    <head>
         <title>Administator - OOU BLOG</title>
