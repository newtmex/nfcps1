<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['uniilorin_exco']);//logout code
if(!isset($_SESSION['uniilorin_exco'])) header('location: http://nfcps.org.ng/uniilorin/exco/');
$user = $_SESSION['uniilorin_exco'];
...
<html>
    ...
    <body>
        ...
        <div id="header">
            <img alt="NFCPS UNIILORIN BLOG" width="100%" src="uniilorin/b_img/header.png" />
        </div>
...
<div class="well">
                    <h5><a href="http://nfcps.org.ng/uniilorin" target="_blank">Back to  blog</a></h5>
                </div>
            </div>
