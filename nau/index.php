...
$prev = $postNum + 1;
$prev = "http://nfcps.org.ng/nau/index.php?article=$prev";
if ($postNum == postCount()['count(id)']) {$prev_display = "display:none;";}
$next = $postNum - 1;
$next = "http://nfcps.org.ng/nau/index.php?article=$next";
if ($postNum == 1) {$next_display = "display:none;";}
$home = postCount()['count(id)'];
$home = "http://nfcps.org.ng/nau/index.php?article=$home";
...
<html>
    <head>
         <title>NFCPS NAU BLOG</title>
         <base href="http://www.nfcps.org.ng">
         <link rel="icon" href="/img/nau.jpg">
        <link rel="stylesheet" href="css/bootstrap.min.css">
        <link rel="stylesheet" href="css/design.css">
        <link rel="stylesheet" href="nau/blog_design.css">
        ...
        <div id="header">
            <img alt="NFCPS NAU BLOG" width="100%" src="nau/b_img/header.png" />
        </div>
        ...
        <!-- Start left side bar-->
            <div class="sidebar col-sm-3">
                <div class="well">
                    <h5>Executive of this School? <a href="http://nfcps.org.ng/nau/exco">Click here to post an article</a></h5>
                </div>
                ...
                <div class="well">
                    ...
                    <?php
                        ...
                        while ($count < 10 && $row = $recent_posts->fetch_assoc()) {
                            $recent = $row['heading'];
                            echo "<a href=\"http://nfcps.org.ng/nau/index.php?article=$totalPosts\">$recent</a><br />";
                            $totalPosts -= 1;
                            $count++;
                        }
