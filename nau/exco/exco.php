<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['nau_exco']);//logout code
if(!isset($_SESSION['nau_exco'])) header('location: /nau/exco/');
$user = $_SESSION['nau_exco'];
require('/home/sites/nfcps.org.ng/public_html/nau/functions.php');
...
<html>
    <head>
         <title>Administator - NAU BLOG</title>
    ...
    <body>
        ...
        <div id="body" class="row">
            <div class="col-sm-3">
                ...
                <div class="well">
                    <h5><a href="http://nfcps.org.ng/nau" target="_blank">Back to blog</a></h5>
                </div>
            </div>
