<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['uniport_exco']);//logout code
if(!isset($_SESSION['uniport_exco'])) header('location: http://nfcps.org.ng/uniport/exco/');
$user = $_SESSION['uniport_exco'];
require('/home/sites/nfcps.org.ng/public_html/uniport/functions.php');
...
<html>
    <head>
         <title>Administator - UNIPORT BLOG</title>
...
<div class="well">
                    <h5><a href="http://nfcps.org.ng/uniport" target="_blank">Back to  blog</a></h5>
                </div>
            </div>
