...
if (isset($_REQUEST['login'])){
  ...
  //CHeck if the user is an exco and is from this school before continuing  
    ...
    if ($rslt['exco'] == "1" && $pwd == $rslt['password'] && $rslt['school'] == "uniport"){
       $_SESSION['uniport_exco'] = $user;//set specific session based on the school
       header('Location: http://nfcps.org.ng/uniport/exco/exco.php'); 
    } else {
...
<html>
    ...
    <body>
        ...
        <div id="header">
            <img alt="NFCPS UNIPORT BLOG" width="100%" src="ui/b_img/header.png" />
        </div>
