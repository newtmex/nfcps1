...
if (isset($_REQUEST['login'])){
  ...
  //CHeck if the user is an exco and is from this school before continuing  
    ...
    if ($rslt['exco'] == "1" && $pwd == $rslt['password'] && $rslt['school'] == "unijos"){
       $_SESSION['unijos_exco'] = $user;//set specific session based on the school
       header('Location: http://nfcps.org.ng/unijos/exco/exco.php'); 
    } else {
...
<html>
    <head>
         <title>Administator - UNIJOSS BLOG</title>
    ...
    <body>
        ...
        <div id="header">
            <img alt="NFCPS unijos BLOG" width="100%" src="ui/b_img/header.png" />
        </div>
