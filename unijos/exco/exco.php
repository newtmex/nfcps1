<?php
session_start();
if(isset($_REQUEST['logout'])) unset($_SESSION['unijos_exco']);//logout code
if(!isset($_SESSION['unijos_exco'])) header('location: http://nfcps.org.ng/unijos/exco/');
$user = $_SESSION['unijos_exco'];
require('/home/sites/nfcps.org.ng/public_html/unijos/functions.php');
...
<html>
    <head>
         <title>Administator - UNIJOS BLOG</title>
...
<div class="well">
                    <h5><a href="http://nfcps.org.ng/unijos" target="_blank">Back to  blog</a></h5>
                </div>
            </div>
